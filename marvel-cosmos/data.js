...
const links = [
    // Faz 1
    { source: "Iron Man", target: "Iron Man 2", type: "direct", description: "Tony Stark'ın Iron Man olduğunu açıklamasıyla başlayan doğrudan devam hikayesi." },
    { source: "Iron Man", target: "The Incredible Hulk", type: "postcredit", description: "Tony Stark, Thaddeus Ross ile barda görüşerek Avengers girişiminden bahseder. (Post-credit)" },
    ...
    { source: "Iron Man 2", target: "Thor", type: "postcredit", description: "Ajan Coulson'ın New Mexico'da Thor'un çekicini (Mjolnir) bulması." },
    { source: "Thor", target: "Avengers (2012)", type: "crossover", description: "Loki'nin dünyaya gelmesi ve Thor'un onu durdurmak için Avengers'a katılması." },
    ...
    { source: "Captain America: The First Avenger", target: "Avengers (2012)", type: "crossover", description: "Buzda donan Steve Rogers'ın uyanıp Nick Fury tarafından Avengers'a dahil edilmesi." },
    { source: "Captain America: The First Avenger", target: "Captain America: The Winter Soldier", type: "event", description: "Bucky Barnes'ın Hydra tarafından Winter Soldier'a dönüştürülüp günümüzde ortaya çıkması." },

    // Avengers 2012 Etkileri
    { source: "Avengers (2012)", target: "Iron Man 3", type: "event", description: "New York savaşının Tony Stark üzerinde bıraktığı ağır PTSD (Travma) etkisi." },
    { source: "Avengers (2012)", target: "Spider-Man: Homecoming", type: "event", description: "New York savaşından kalan Chitauri uzaylı enkazlarının Vulture tarafından toplanması." },
    { source: "Avengers (2012)", target: "Hawkeye", type: "event", description: "Kate Bishop'ın New York işgali sırasında Hawkeye'ı görüp ondan ilham alması." },
    ...
    { source: "Avengers (2012)", target: "Loki", type: "crossover", description: "2012'deki Tesseract'ı çalan alternatif zaman çizelgesindeki Loki'nin hikayesi." },
    ...
    { source: "Thor: The Dark World", target: "Guardians of the Galaxy", type: "postcredit", description: "Sif ve Volstagg'ın Reality Stone'u (Aether) Collector'a (The Collector) teslim etmesi." },
    ...
    { source: "Captain America: The Winter Soldier", target: "Avengers: Age of Ultron", type: "event", description: "SHIELD'ın çöküşü sonrası Hydra üslerine yapılan baskınların Avengers'ı tekrar toplaması." },
    { source: "Guardians of the Galaxy", target: "Infinity War", type: "crossover", description: "Guardians ekibinin uzayda Thor ile karşılaşması ve Thanos tehdidine dahil olması." },
    ...
    { source: "Avengers: Age of Ultron", target: "Thor: Ragnarok", type: "crossover", description: "Hulk'ın (Bruce Banner) Quinjet ile uzaya uçması ve Sakaar gezegenine düşmesi." },
    { source: "Ant-Man", target: "Captain America: Civil War", type: "crossover", description: "Falcon'ın Ant-Man'i keşfedip Captain America'nın takımına dahil etmesi." },
    ...
    { source: "Captain America: Civil War", target: "Spider-Man: Homecoming", type: "crossover", description: "Tony Stark'ın Peter Parker'ı takıma alması ve Peter'ın okul hayatına dönüşü." },
    ...
    { source: "Captain America: Civil War", target: "Black Widow", type: "event", description: "Natasha'nın anlaşmaları ihlal ettiği için kaçak durumuna düşmesi ve geçmişiyle yüzleşmesi." },
    { source: "Doctor Strange", target: "Thor: Ragnarok", type: "crossover", description: "Doctor Strange'in Thor'a babası Odin'i bulması için yardım etmesi." },
    ...
    { source: "Thor: Ragnarok", target: "Infinity War", type: "direct", description: "Asgard mülteci gemisinin uzayda doğrudan Thanos'un ana gemisiyle karşılaşması." },
    { source: "Captain Marvel", target: "Infinity War", type: "postcredit", description: "Nick Fury'nin toza dönüşmeden saniyeler önce çağrı cihazıyla Captain Marvel'ı çağırması." },
    ...
    { source: "Infinity War", target: "Endgame", type: "direct", description: "Thanos'un parmak şıklatması (The Snap) ve Avengers'ın kalan üyelerinin intikam arayışı." },
    ...
    { source: "Endgame", target: "The Falcon and the Winter Soldier", type: "event", description: "Yaşlı Steve Rogers'ın kalkanı Sam Wilson'a devretmesi." },
    { source: "Endgame", target: "WandaVision", type: "event", description: "Vision'ın ölümü sonrası yas tutan Wanda'nın Westview kasabasını gerçeklik büyüsüyle ele geçirmesi." },
    { source: "Endgame", target: "Hawkeye", type: "event", description: "Clint Barton'ın Ronin olarak işlediği cinayetlerin geçmişinden gelip onu bulması." },
    { source: "Endgame", target: "Eternals", type: "event", description: "Hulk'ın şıklatmasıyla milyarlarca insanın geri dönmesinin Celestial Tiamut'un uyanış enerjisini tetiklemesi." },
    { source: "Endgame", target: "Thor: Love and Thunder", type: "direct", description: "Thor'un Guardians of the Galaxy ekibiyle uzaya açılması ve kilolarından kurtulması." },
    ...
    { source: "Spider-Man: Far From Home", target: "Spider-Man: No Way Home", type: "direct", description: "Mysterio'nun ölmeden önce Spider-Man'in kimliğini tüm dünyaya ifşa etmesi." },

    // Faz 4
    { source: "WandaVision", target: "Agatha All Along", type: "direct", description: "Wanda'nın Agatha Harkness'ı Westview'da hafızası silinmiş bir şekilde hapsetmesi." },
    ...
    { source: "Loki", target: "Quantumania", type: "crossover", description: "He Who Remains'in ölümüyle Çoklu Evrenin parçalanması ve Kang varyantlarının serbest kalması." },
    ...
    { source: "Black Widow", target: "Hawkeye", type: "crossover", description: "Yelena Belova'nın Natasha'nın ölümünden Clint Barton'ı sorumlu tutup peşine düşmesi." },
    ...
    { source: "Hawkeye", target: "Echo", type: "crossover", description: "Maya Lopez'in (Echo) Kingpin'in kendisini kandırdığını öğrenip onu vurması." },
    ...
    { source: "Ms. Marvel", target: "The Marvels", type: "direct", description: "Kamala Khan'ın bilekliğinin gücüyle Carol Danvers ile yer değiştirmesi." },
    ...
    // Faz 5
    { source: "Quantumania", target: "Loki", type: "postcredit", description: "Loki ve Mobius'un 1920'lerde Kang varyantı Victor Timely'yi bulması (Post-credit)." },
